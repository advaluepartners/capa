...
export const DEFAULT_HOME = 'https://vfstiltjrbndziotcluh.supabase.co/project/{ref}'
export const API_URL = 'https://vfstiltjrbndziotcluh.supabase.co/rest/v1'
export const API_ADMIN_URL = undefined
