...
const csp = [
  ...
  process.env.NEXT_PUBLIC_ENVIRONMENT === 'staging'
    ? [ 
        ...
        `connect-src 'self' ${SUPABASE_PROJECTS_URL_WS} ${SUPABASE_LOCAL_PROJECTS_URL_WS} ${SUPABASE_STAGING_PROJECTS_URL_WS} ${PUSHER_URL_WS};`,
    ...
    : [
        ...
        `connect-src 'self' ${SUPABASE_PROJECTS_URL_WS} ${SUPABASE_LOCAL_PROJECTS_URL_WS};`,
        `frame-src 'self' ${FRAME_SRC_URLS};`,
...
const nextConfig = {
    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: process.env.NEXT_PUBLIC_IS_PLATFORM === 'false' ? csp : "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data:;", //"frame-ancestors 'none';",
          },
          {
            key: 'Referrer-Policy',
  ...
  images: {
    ...
    domains: [
      ...
      'vercel.com',
      'vfstiltjrbndziotcluh.supabase.co',
    ],
  },
  transpilePackages: [
    'ui',
